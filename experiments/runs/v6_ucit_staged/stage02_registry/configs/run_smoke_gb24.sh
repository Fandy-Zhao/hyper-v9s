...
export V6_REGISTRY_ARTIFACT_DIR=/home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage02_registry/smoke/runtime
export V6_SOURCE_GIT_COMMIT=5668cfd
export V6_RUN_ID=run_smoke_gb24
...
/home/zhaozhuofan/miniconda3/envs/hyper/bin/deepspeed --include localhost:0,1,2,3 --master_port 29720 /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage02_registry/scripts/stage02_train_entry.py \
    ...
    --bf16 True \
    --output_dir "/data/ckpt/zhaozhuofan/v6_ucit_staged/stage02_registry/checkpoints/smoke_gb24" \
    --num_train_epochs 1 \
