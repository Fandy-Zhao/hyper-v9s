...
export V6_REGISTRY_ARTIFACT_DIR=/home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage02_registry/mini2/task2_runtime
export V6_SOURCE_GIT_COMMIT=5668cfd
export V6_RUN_ID=run_mini2_gb24_task2
...
PREVIOUS_TASK_MODEL_PATH="/data/ckpt/zhaozhuofan/v6_ucit_staged/stage02_registry/checkpoints/mini2_gb24_task1_llava_lora_ours"
...
/home/zhaozhuofan/miniconda3/envs/hyper/bin/torchrun --nproc_per_node=4 --master_port 29752 /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage02_registry/scripts/stage02_train_entry.py \
    ...
    --bf16 True \
    --output_dir "/data/ckpt/zhaozhuofan/v6_ucit_staged/stage02_registry/checkpoints/mini2_gb24_task2_llava_lora_ours" \
    --num_train_epochs 1 \
