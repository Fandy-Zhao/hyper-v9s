# Stage 02 generated launch; source: run_mini2_gb24_task2.sh
export CUDA_VISIBLE_DEVICES=4,5,6,7
export PYTHONPATH=/home/zhaozhuofan/Hyper-LlaVA:${PYTHONPATH:-}
export V6_REGISTRY_ARTIFACT_DIR=/home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/mini2/task2_runtime
export V6_SOURCE_GIT_COMMIT=8d826f2
export V6_RUN_ID=stage03_mini2_gb24_task2
export V6_RUN_TIMESTAMP=2026-08-02T05:35:00+08:00
...
PREVIOUS_TASK_MODEL_PATH="/data/ckpt/zhaozhuofan/v6_ucit_staged/stage03_composition/checkpoints/mini2_gb24_task1_llava_lora_ours"
OUTPUT_DIR="${OUTPUT_DIR:-/data/ckpt/zhaozhuofan/hyper_llava/Hyper/UCIT/Task2_llava_lora_ours}"
################## VICUNA ##################
...
/home/zhaozhuofan/miniconda3/envs/hyper/bin/torchrun --nproc_per_node=4 --master_port 29736 /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/scripts/stage03_train_entry.py \
    ...
    --data_path /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage01_baseline/data_indices/ArxivQA/train.json \
    ...
    --bf16 True \
    --output_dir "/data/ckpt/zhaozhuofan/v6_ucit_staged/stage03_composition/checkpoints/mini2_gb24_task2_llava_lora_ours" \
    --num_train_epochs 1 \
