# Stage 02 generated launch; source: run_mini2_gb24_task1.sh
export CUDA_VISIBLE_DEVICES=4,5,6,7
export PYTHONPATH=/home/zhaozhuofan/Hyper-LlaVA:${PYTHONPATH:-}
export V6_REGISTRY_ARTIFACT_DIR=/home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/mini2/task1_runtime
export V6_SOURCE_GIT_COMMIT=8d826f2
export V6_RUN_ID=stage03_mini2_gb24_task1
...
/home/zhaozhuofan/miniconda3/envs/hyper/bin/torchrun --nproc_per_node=4 --master_port 29735 /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/scripts/stage03_train_entry.py \
    ...
    --data_path /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage01_baseline/data_indices/ImageNet-R/train.json \
    ...
    --bf16 True \
    --output_dir "/data/ckpt/zhaozhuofan/v6_ucit_staged/stage03_composition/checkpoints/mini2_gb24_task1_llava_lora_ours" \
    --num_train_epochs 1 \
