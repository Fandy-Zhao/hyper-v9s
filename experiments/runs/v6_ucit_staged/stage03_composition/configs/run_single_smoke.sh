...
export V6_REGISTRY_ARTIFACT_DIR=/home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/smoke/single/runtime
export V6_SOURCE_GIT_COMMIT=8d826f2
export V6_RUN_ID=stage03_single_smoke_gb24
export V6_RUN_TIMESTAMP=2026-08-02T05:22:00+08:00
...
/home/zhaozhuofan/miniconda3/envs/hyper/bin/torchrun --nproc_per_node=4 --master_port 29733 /home/zhaozhuofan/Hyper-LlaVA/experiments/runs/v6_ucit_staged/stage03_composition/scripts/stage03_train_entry.py \
    ...
    --bf16 True \
    --output_dir "/data/ckpt/zhaozhuofan/v6_ucit_staged/stage03_composition/checkpoints/single_smoke_gb24" \
    --num_train_epochs 1 \
