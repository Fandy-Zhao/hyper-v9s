# V6 UCIT Seed 43 — Final Report

- config：`configs/v6_ucit_formal_locked.yaml`（hash `30020824bf7bf084`）
- Git HEAD：`8d67139d897f075c22116653ce6407e766ae5fee`
- run root：`experiments/runs/v6_ucit_engineering/formal/seed_43`
...
| 9 | 原 Hyper eval 六阶段全部完成（每任务 3000 样本） | **PASS** | ['task0 samples=3000 preds=3000 dur=568s', 'task1 samples=3000 preds=3000 dur=939s', 'task2 samples=3000 preds=3000 dur=1867s', 'task3 samples=3000 preds=3000 dur=747s', 'task4 samples=3000 preds=3000 dur=611s', 'task5 samples=3000 preds=3000 dur=1940s'] |
...
| 15 | exact resume command 有效 | **PASS** | command: bash scripts/v6_ucit/resume_run.sh 43 4,5,6,7 (idempotent re-run verified by run completion) |
