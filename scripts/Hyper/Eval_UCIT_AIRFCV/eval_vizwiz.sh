...
RESULT_DIR="runs/results/UCIT_AIRFCV/each_dataset/VizWiz"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_answer \
        ...
        --question-file /data/dataset/zhaozhuofan/UCIT/instructions/VizWiz/test_3000.json \
...
python -m llava.eval.eval_caption \
    --annotation-file /data/dataset/zhaozhuofan/UCIT/instructions/VizWiz/val_coco_type_3000.json \
