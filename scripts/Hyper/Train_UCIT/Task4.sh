...
PREVIOUS_TASK_MODEL_PATH="${PREVIOUS_TASK_MODEL_PATH:-runs/checkpoints/Hyper/UCIT/Task3_llava_lora_ours}"
OUTPUT_DIR="${OUTPUT_DIR:-/data/ckpt/zhaozhuofan/hyper_llava/Hyper/UCIT/Task4_llava_lora_ours}"
################## VICUNA ##################
...
deepspeed --include localhost:0,1,2,3 --master_port 29601 llava/train/train_mem_MOE.py \
    ...
    --data_path /data/dataset/zhaozhuofan/UCIT/instructions/IconQA/train.json \
