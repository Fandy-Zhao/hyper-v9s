...
PREVIOUS_TASK_MODEL_PATH="${PREVIOUS_TASK_MODEL_PATH:-runs/checkpoints/Hyper/UCIT/Task1_llava_lora_ours}"
...
deepspeed --include localhost:0,1,2,3 --master_port 29601 llava/train/train_mem_MOE.py \
    ...
    --data_path /data/dataset/zhaozhuofan/UCIT/instructions/ArxivQA/train_4w.json \
