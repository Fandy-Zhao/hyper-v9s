...
deepspeed --include localhost:0 --master_port 29601 llava/train/train_mem_MOE.py \
    --deepspeed ./scripts/zero2.json \
    --lora_enable True --lora_r 48 --lora_alpha 96 --mm_projector_lr 2e-5 \
    --expert_num 6 \
    --model_name_or_path models/llava-v1.6-mistral-7b \
    --version $PROMPT_VERSION \
    --data_path /data/dataset/zhaozhuofan/UCIT/instructions/ImageNet-R/train.json \
    ...
    --bf16 True \
    --output_dir runs/checkpoints/Hyper/UCIT_Next/Task1_llava_lora_ours \
    --num_train_epochs 1 \
