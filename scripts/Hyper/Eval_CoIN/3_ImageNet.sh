...
gpu_list="${CUDA_VISIBLE_DEVICES:-0,1,2,3,6,7}" # 
...
RESULT_DIR="./runs/results/CoIN/each_dataset/ImageNet"
...
python -m llava.eval.eval_imagenet \
    --test-file instructions/ImageNet/test.json \
