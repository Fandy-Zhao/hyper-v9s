...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29601 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path runs/checkpoints/HiDe/CoIN/Task5_llava_lora_ours \
    --version $PROMPT_VERSION \
    --data_path instructions/Grounding/train.json \
    ...
    --bf16 True \
    --output_dir runs/checkpoints/HiDe/CoIN/Task6_llava_lora_ours \
    --num_train_epochs 1 \
