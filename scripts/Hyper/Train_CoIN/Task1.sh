...
deepspeed --include localhost:0,1,2,3 --master_port 29603 llava/train/train_mem_MOE.py \
    ...
    --image_folder /home/zhangyanqin/DATA/CoIN \
    ...
    --bf16 True \
    --output_dir runs/checkpoints/HiDe/CoIN/Task1_llava_lora_ours \
    --num_train_epochs 1 \
